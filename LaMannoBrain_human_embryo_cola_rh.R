setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_human_embryo")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_human_embryo/LaMannoBrain_human_embryo_data.rds')
